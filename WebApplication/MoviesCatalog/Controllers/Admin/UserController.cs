...
namespace Movies.Controllers.Admin
{
    ...
    public class UserController : Controller
    {
        ...
        private void SetUserRoles(EditUserViewModel model, ApplicationUser user, MoviesDbContext db)
        {
        ...
        private List<Role> GetUserRoles(ApplicationUser user, MoviesDbContext db)
        {
            // Create user manager
            var userManager = Request
                .GetOwinContext()
        ...
        private HashSet<string> GetAdminUserNames(List<ApplicationUser> users, MoviesDbContext context)
        {
